...
Referral links are generated from `{{REF}}` in content: `https://stakebet.gg/ref/QQ6Z5TTZ?c=ccl&s=<page-slug>` (no `lp`, so the click goes straight to registration with the code applied).
